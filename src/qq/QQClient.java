...
public class QQClient //这里需要用生成对象的方法来吗
{
	public  String name;
	...
	public static void main(String[] args) throws UnknownHostException, IOException
	{
		...
		System.out.println(qqClient.localip+":"+qqClient.socket.getLocalPort());//这个
		
		//在这里要向服务器注册一下，告诉它我上线了  注册格式自己 #name#当前ip#
		String loginstr="#"+qqClient.name+"#"+qqClient.localip+"#";
		OutputStream login= qqClient.socket.getOutputStream();
		login.write(loginstr.getBytes());
		
		//理论上这里需要接收下服务器返回的信息，是统一还是不统一登录系统
